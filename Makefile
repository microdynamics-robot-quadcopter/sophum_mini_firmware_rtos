...
EXTRA_COMPONENT_DIRS += $(PROJECT_PATH)/modules/sophum_module_bmp388/bosch_api
EXTRA_COMPONENT_DIRS += $(PROJECT_PATH)/modules/sophum_module_bno055
EXTRA_COMPONENT_DIRS += $(PROJECT_PATH)/modules/sophum_module_bno055/bosch_api
...
COMPONENT_INCLUDES += $(PROJECT_PATH)/modules/sophum_module_bmp388/bosch_api
COMPONENT_INCLUDES += $(PROJECT_PATH)/modules/sophum_module_bno055
COMPONENT_INCLUDES += $(PROJECT_PATH)/modules/sophum_module_bno055/bosch_api
