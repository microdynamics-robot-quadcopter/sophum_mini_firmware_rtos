...
static bool MPU9250_getSlaveEnabled(uint8_t num)
{
    ...
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                   MPU9250_I2C_SLV_EN_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static bool MPU9250_getSlaveWordByteSwap(uint8_t num)
{
    if(num > 3) return 0;
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                   MPU9250_I2C_SLV_BYTE_SW_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static bool MPU9250_getSlaveWriteMode(uint8_t num)
{
    if(num > 3) return 0;
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                   MPU9250_I2C_SLV_REG_DIS_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static bool MPU9250_getSlaveWordGroupOffset(uint8_t num)
{
    if(num > 3) return 0;
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                   MPU9250_I2C_SLV_GRP_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static uint8_t MPU9250_getSlaveDataLength(uint8_t num)
{
    ...
    I2C_readMultiBits(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                      MPU9250_I2C_SLV_LEN_BIT, MPU9250_I2C_SLV_LEN_LEN, tmp_buf);
    return tmp_buf[0];
}
...
static void MPU9250_setSlaveDataLength(uint8_t num, uint8_t len)
{
    ...
    I2C_writeMultiBits(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV0_CTRL + num * 3,
                       MPU9250_I2C_SLV_LEN_BIT, MPU9250_I2C_SLV_LEN_LEN, len);
}
...
static bool MPU9250_getSlave4Enabled(void)
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                   MPU9250_I2C_SLV4_EN_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static void MPU9250_setSlave4Enabled(bool enabled)
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                    MPU9250_I2C_SLV4_EN_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                   MPU9250_I2C_SLV4_DONE_INT_EN_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                    MPU9250_I2C_SLV4_DONE_INT_EN_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                   MPU9250_I2C_SLV4_REG_DIS_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static uint8_t MPU9250_getSlave4MasterDelay(void)
{
    I2C_readMultiBits(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_SLV4_CTRL,
                      MPU9250_I2C_SLV4_MST_DLY_BIT, MPU9250_I2C_SLV4_MST_DLY_LEN,
                      tmp_buf);
    return tmp_buf[0];
}
...
static bool MPU9250_getPassthroughStatus(void)
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_PASS_THROUGH_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV4_DONE_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_LOST_ARB_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV4_NACK_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV3_NACK_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV2_NACK_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV1_NACK_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_I2C_MST_STATUS,
                   MPU9250_MST_STATUS_I2C_SLV0_NACK_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static void MPU9250_resetGyroscopePath(void)
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_SIGNAL_PATH_RESET,
                    MPU9250_SIGNAL_PATH_RESET_GYRO_RESET_BIT, 1);
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_SIGNAL_PATH_RESET,
                    MPU9250_SIGNAL_PATH_RESET_ACCE_RESET_BIT, 1);
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_SIGNAL_PATH_RESET,
                    MPU9250_SIGNAL_PATH_RESET_TEMP_RESET_BIT, 1);
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_USER_CTRL,
                    MPU9250_USER_CTRL_FIFO_RESET_BIT, 1);
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_USER_CTRL,
                    MPU9250_USER_CTRL_I2C_MST_RESET_BIT, 1);
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_USER_CTRL,
                    MPU9250_USER_CTRL_SIG_COND_RESET_BIT, 1);
}
...
static bool MPU9250_getStandbyXAccelEnabled(void)
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_XA_BIT, tmp_buf);
    return tmp_buf[0];
}
...
static void MPU9250_setStandbyXAccelEnabled(bool enabled)
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_XA_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_YA_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_YA_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_ZA_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_ZA_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_XG_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_XG_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_YG_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_YG_BIT, enabled);
}
...
{
    I2C_readOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                   MPU9250_PWR_MGMT_2_DIS_ZG_BIT, tmp_buf);
    return tmp_buf[0];
}
...
{
    I2C_writeOneBit(I2C_NUM1_MASTER_PORT_GPIO, MPU9250_ADDR, MPU9250_PWR_MGMT_2,
                    MPU9250_PWR_MGMT_2_DIS_ZG_BIT, enabled);
}
